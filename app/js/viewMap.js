...
define({
    ...
    'session4_11' : genrateJsBinSessionDetails({sid:4, ssid: '11', url: '//jsbin.com/ashishJSAbstractClass/4/embed?js,console', next: 'session4_11'}),
    ...
    'session5_4'  : genrateJsBinSessionDetails({sid:5, ssid: '4',  url: '//jsbin.com/requirejs5/1/embed?js,console'}),
    'session5_5'  : genrateJsBinSessionDetails({sid:5, ssid: '5',  url: '//requirejs.org/docs/api.html#config'}),
    'session5_6'  : genrateJsBinSessionDetails({sid:5, ssid: '6',  url: '//jsbin.com/_1/2'}),
    'session5_7'  : genrateJsBinSessionDetails({sid:5, ssid: '7',  url: '//jsbin.com/_2/9/embed?js,console'}),
    'session5_8'  : genrateJsBinSessionDetails({sid:5, ssid: '8',  url: '//jsbin.com/_3/2/embed?js,console'}),
    'session5_9'  : genrateJsBinSessionDetails({sid:5, ssid: '9',  url: '//jsbin.com/_4/2/embed?js,console'}),
    'session5_10' : genrateJsBinSessionDetails({sid:5, ssid: '10', url: '//jsbin.com/_5/2/embed?js,console'}),
    'session5_11' : genrateJsBinSessionDetails({sid:5, ssid: '11', url: '//jsbin.com/_6/2/embed?js,console'}),
});